...
const INITIAL_ACTIVITIES = [
  {
    id: 1,
    title: "Winner – VAP 2024 Innovation Program",
    date: "March 2024",
    type: "image",
    category: "Milestone",
    src: "https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=2070&auto=format&fit=crop",
    media_urls: ["https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=2070&auto=format&fit=crop"],
    description: "Proud to have won the prestigious VAP 2024 Innovation Program with a technology solution aimed at addressing real-world community discovery problems.",
    likes: 12
  },
  {
    id: 2,
    title: "TechAspria Hackathon Collaboration",
    date: "October 2024",
    type: "image",
    category: "Coding Sessions",
    src: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2069&auto=format&fit=crop",
    media_urls: ["https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2069&auto=format&fit=crop"],
    description: "Secured runner-up position at the TechAspria Hackathon working alongside incredibly talented engineers and designers on rapid prototyping systems.",
    likes: 18
  },
  {
    id: 3,
    title: "Student Lab Innovation Projects",
    date: "January 2024",
    type: "image",
    category: "Design",
    src: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop",
    media_urls: ["https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=2070&auto=format&fit=crop"],
    description: "An exploratory presentation of custom interactive interface prototypes and user journey models developed at the engineering Innovation Labs.",
    likes: 8
  }
];
...
const INITIAL_COMMENTS = {
  1: [
    { id: 101, name: "Aman", content: "Huge congratulations Ritik! Well deserved win.", created_at: "2024-03-15T10:00:00Z" }
  ],
  2: [
    { id: 201, name: "Sneha", content: "Awesome collaboration guys! Proud moment.", created_at: "2024-10-18T14:30:00Z" }
  ],
  3: [
    { id: 301, name: "Priya", content: "Love the design thinking and prototypes!", created_at: "2024-01-22T09:15:00Z" }
  ]
};
...
const Gallery = () => {
    ...
    const fetchComments = (galleryId) => {
        setLoadingComments(true);
        const data = allComments[galleryId] || [];
        setComments(data);
        setLoadingComments(false);
    };

    const handleLike = (e, activity) => {
        e.stopPropagation();
    ...
    const handlePostComment = (e) => {
        ...
        const updatedCommentsForActivity = [newComment, ...(allComments[activityId] || [])];
        
        setAllComments({
            ...allComments,
            [activityId]: updatedCommentsForActivity
        });
        
        setComments(updatedCommentsForActivity);
