...
import { FaGithub, FaEnvelope, FaLinkedin, FaDownload, FaBriefcase, FaCode, FaCertificate, FaGlobe, FaArrowRight, FaCube } from 'react-icons/fa';
...
const Home = () => {
    ...
    const stats = [
        { icon: <FaCode />, value: "2", title: "TOTAL PROJECTS", description: "Full-stack web applications built" },
        { icon: <FaCertificate />, value: "4", title: "CERTIFICATES", description: "Professional skills validated" },
        { icon: <FaGlobe />, value: "2023-2027", title: "ACADEMIC TIMELINE", description: "Computer Engineering student" },
    ];
        ...
        >
          ...
          ${is3dEnabled
            ...
            <section id="home" className="flex flex-col md:flex-row items-center gap-10 pt-20 pb-16 lg:pt-0 lg:pb-20">
                <div className="flex-1 dark:text-white text-slate-800 space-y-6 pt-16 md:pt-40 order-last md:order-none text-center md:text-left flex flex-col items-center md:items-start">
                    ...
                    <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.55, ease: "easeOut" }}>
                        <TextGenerateEffect words={'I build high-performance, scalable full-stack web applications and software solutions.'} />
                    </motion.div>
            ...
            >
                ...
                <div className="flex flex-col md:flex-row items-center justify-center">
                    ...
                    >
                        ...
                        <h3 className="text-4xl font-bold dark:text-white text-slate-900 my-2 font-moderniz" style={{ textShadow: theme === 'dark' ? "2px 2px 0 #000754, 4px 4px 0 #4079ff, 0 4px 12px #40ffaa, 0 1px 0 #00ffdc" : "none" }}>Ritik Swaraj</h3>
                        <p className="dark:text-white/80 text-slate-600 leading-relaxed mt-4 font-cascadia text-justify">
                            I am a Computer Engineering student at Mumbai University (VIMEET) with a deep passion for exploring software development, product thinking, and technical problem-solving. I have hands-on experience building robust full-stack web applications while collaborating with teams to translate requirements into user-focused features.
                        </p>
            ...
            <footer className="py-12 pb-16 text-center text-gray-400 dark:bg-gradient-to-t dark:from-slate-900/50 dark:to-transparent bg-gradient-to-t from-slate-100/50 to-transparent">
                <div className="text-sm">© {new Date().getFullYear()} Ritik Swaraj. All rights reserved.</div>
            </footer>
        </motion.div>
    );
};
