...
const Preloader = ({ onFinished }) => {
  ...
  const fullText = "github.com/rswaraj09";
        ...
        >
          {showContent && (
            ...
            >
              ...
              >
                <a href="https://github.com/rswaraj09" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Github size={32} />
                </a>
                <a href="https://www.linkedin.com/in/ritik-swaraj-b54812314" target="_blank" rel="noopener noreferrer" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Linkedin size={32} />
                </a>
                <a href="mailto:contactritikswaraj@gmail.com" className="dark:hover:text-[#00ffdc] hover:text-cyan-600 transition-all duration-300 transform hover:scale-110">
                  <Mail size={32} />
                </a>
              </motion.div>
            </motion.div>
