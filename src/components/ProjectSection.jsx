...
import {
  ...
  SiExpress, SiPostgresql, SiSpringboot, SiMysql,
  SiTypescript, SiPostman, SiPython
} from 'react-icons/si';
...
const dummyProjects = [
  {
    ...
    link: "https://github.com/rswaraj09/Locality-Connector",
  ...
  },
  {
    ...
    description: "A secure, production-style web platform incorporating robust JWT-based user authentication and payment checkout integrations. Leveraged AI-based recommendation features to drive user engagement and custom personalization.",
    tech: ["React", "Node.js", "MongoDB", "JavaScript"],
    link: "https://github.com/rswaraj09/travel_tourism",
...
// ===================================
// DATA SERTIFIKAT RITIK SWARAJ
// ===================================
const userCertificates = [
  {
    title: "Winner – VAP 2024 Innovation Program",
    issuer: "VAP Innovation Program",
    date: "2024",
    link: "#",
    image: "https://images.unsplash.com/photo-1531482615713-2afd69097998?q=80&w=2070&auto=format&fit=crop",
  },
  {
    title: "Runner-up – TechAspria",
    issuer: "TechAspria",
    date: "2024",
    link: "#",
  ...
  {
    title: "Shortlisted – YUKTI Innovation",
...
const techStack = {
  ...
  backend: [
    ...
    { name: "RESTful APIs", icon: <PiCodeBold className="text-cyan-400" /> },
  ],
  database: [
  ...
  tools: [
    ...
    { name: "Agile & SDLC", icon: <FaTools className="text-gray-400" /> },
  ],
};
