...
import cardTextureImg from '../../assets/Lanyard/ritik_id_card.png';
...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
  ...
  const cardTexture = useTexture(cardTextureImg);
  cardTexture.flipY = false; // Match GLTF coordinate system to avoid upside-down texture
